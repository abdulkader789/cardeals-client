        ...
        <section className="text-gray-700 body-font  border-gray-200">
            <div className="container px-5 py-24 mx-auto ">
                <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
                    <h1 className="  text-center text-4xl font-extrabold text-gray-900 sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
                        <span className="block text-slate-900 xl:inline capitalize ">why buy from us?</span>
                    </h1>
                </div>
