            ...
            <main className="flex-1 md:p-0 lg:pt-8 lg:px-8  flex flex-col">
                <section className="bg-cream-lighter p-4 shadow">
                    <div className="md:flex">
                        <h2 className="md:w-1/3 uppercase tracking-wide text-sm sm:text-lg mb-6">Create User</h2>
                    </div>
                    <div>
                        ...
                        <div className="md:flex mb-6 border border-t-1 border-b-0 border-x-0 border-cream-dark">
                            <div className="md:flex-1 px-3 text-center md:text-right">
                                <button onClick={handleCreateUser} className="button text-cream-lighter bg-brick hover:bg-brick-dark" >
                                    Create User
                                </button>
                            </div>
                        </div>
