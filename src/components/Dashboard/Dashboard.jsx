        ...
        <main className="p-6 sm:p-10 space-y-6">
            {/* <div className="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
                ...
                <div className="flex flex-wrap items-start justify-end -mb-3">
                    ...
                    <button className="inline-flex px-5 py-3 text-purple-600 hover:text-purple-700 focus:text-purple-700 hover:bg-purple-100 focus:bg-purple-100 border border-purple-600 rounded-md mb-3 ml-6">
            ...
            <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
                ...
                <div style={{ backgroundColor: background.users }} className="flex items-center p-8  shadow rounded-sm">
                    ...
                    <div className="cursor-pointer">
                        <span className="block text-2xl text-white font-bold">20</span>
                ...
                <div style={{ backgroundColor: background.pending }} className="flex items-center p-8  shadow rounded-sm">
                    ...
                    <div>
                        <span className="block text-2xl text-white font-bold">6</span>
                ...
                <div style={{ backgroundColor: background.process }} className="flex items-center p-8  shadow rounded-sm">
                    ...
                    <div>
                        <span className="inline-block text-2xl text-white font-bold">9</span>

                        <span className="block text-white">Order Process</span>
                    </div>
                </div>
